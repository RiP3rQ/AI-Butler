...
const PdfsDashboard = () => {
  ...
  return (
    <div className={"w-full flex-col flex items-center justify-center"}>
      <div
        className="w-full mt-8 flex flex-col items-center justify-center border-b border-gray-200 pb-5 sm:flex-row sm:items-center sm:gap-0">
        <UploadButton isSubscribed={false} />
      </div>

      {/* display all user files */}
      {files && files?.length !== 0 ? (
        <ul className="mt-8 grid grid-cols-1 gap-6 divide-y divide-zinc-200 md:grid-cols-2 lg:grid-cols-3 w-full">
          {files
            .sort(
              (a: any, b: any) =>
            ...
            .map((file: any) => (
              <li
                ...
                <div className="px-6 mt-4 flex items-center justify-between py-2 gap-6 text-xs text-zinc-500 w-full">
