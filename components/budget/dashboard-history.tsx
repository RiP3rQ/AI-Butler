...
import HistoryPeriodSelector from "@/components/budget/history-period-selector";
...
function History() {
  ...
  const historyDataQuery = useQuery({
    ...
    queryFn: () =>
      fetch(
        `/api/budget/history-data?timeframe=${timeframe}&year=${period.year}&month=${period.month}`,
      ).then((res) => res.json()),
  });
